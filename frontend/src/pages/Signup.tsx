    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-orange-50 flex items-center justify-center p-4 py-12 overflow-x-hidden">
      <div className="w-full max-w-md">
        ...
        <div className="bg-bg-secondary rounded-3xl shadow-xl p-8 md:p-10">
          <h1 className="text-3xl font-bold text-text-primary mb-2">Join your campus</h1>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#e8684a] focus:border-transparent outline-none transition text-text-primary"
                  placeholder="John"
                  required
                  disabled={loading}
                />
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-bg-secondary text-text-muted">Or sign up with</span>
            </div>
          </div>

          {/* Social Signup */}
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-xl hover:bg-bg-primary transition" disabled={loading}>
